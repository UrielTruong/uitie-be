...
{
public function \_\_construct(private readonly Post $model) {}
...
$this->app->bind(PostRepositoryInterface::class, PostRepository::class); 6. Add route in routes/api.php
